...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url('login/unauth'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2024 <a href="https://adminlte.io">Andra</a>.</strong> All rights
    reserved.
  </footer>
  <!-- Control Sidebar -->
